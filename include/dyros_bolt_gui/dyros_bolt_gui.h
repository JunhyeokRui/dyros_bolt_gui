...
#ifndef dyros_bolt_gui__DyrosBoltGUI_H
#define dyros_bolt_gui__DyrosBoltGUI_H
...
#include "dyros_bolt_msgs/VelocityCommand.h"
...
namespace dyros_bolt_gui
{
    ...
    class DyrosBoltGui : public rqt_gui_cpp::Plugin
    {
        Q_OBJECT
    public:
        DyrosBoltGui();
    ...
    protected slots:
        ...
        virtual void DyrosBoltStarter();
        virtual void DyrosBoltStopper();
    ...
    public:
        ...
        dyros_bolt_msgs::positionCommand poscom_msg;

        ros::Publisher task_pub;
        dyros_bolt_msgs::TaskCommand task_msg;

        ros::Publisher task_que_pub;
        dyros_bolt_msgs::TaskCommandQue task_que_msg;

        ros::Publisher taskgain_pub;
        dyros_bolt_msgs::TaskGainCommand taskgain_msg;

        ros::Publisher velcommand_pub;
        dyros_bolt_msgs::VelocityCommand velcmd_msg;

        ros::Publisher arm_gain_pub;
        std_msgs::Float32MultiArray arm_gain_msg;

        ros::Publisher dyros_bolt_starter_pub;

        ros::Publisher dyros_bolt_stopper_pub;
